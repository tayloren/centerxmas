...
<body>
<div id="header">
  <h1>Center Family Events</h1>
</div>
<div id="pages">
  <ul>
    <li class="active"><a id="page1" href="index.php">home</a></li>
...
<div id="content">
  <div id="colOne">
    <div id="latest-post">
    <h2>Center Family Event Site</h2>
    <hr>
      <?php
	...
	{
        extract ($row);
	echo "<div class='story'><img src='$image_path' alt='' width='180' height='135' class='image' />";
	echo "<p><em><strong>$post_title</strong></em>";
        echo "<h3 class='posted'>Posted on $date</h3>";
	echo "$post</p>";
	}
	?>
	</div>
...
<!-- Add the include for the recent posts -->
